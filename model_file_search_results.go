...
// checks if the FileSearchResults type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileSearchResults{}

// FileSearchResults struct for FileSearchResults
...
func (o FileSearchResults) ToMap() (map[string]interface{}, error) {
